...
public class Watermarking_Controller
{
	
	private Watermarking_View	view;
	...
	public Watermarking_Controller(Watermarking_View aView, Watermarking aModel)
	{
		//program variables
		view  = aView;
		model = aModel;
	...
	{
		new Watermarking_Controller(
									new Watermarking_View("Steganography"),
									new Watermarking()
									);
	}
}